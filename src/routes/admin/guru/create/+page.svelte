...
<div class="p-8">
    <form 
        ...
        <div class="p-6 border-b border-zinc-400 dark:border-zinc-800">
            <h1 class="text-xl font-bold text-gray-800 dark:text-gray-100">Tambah Guru Baru</h1>
        </div>
        ...
        <div class="p-6 space-y-4">
            <div class="grid grid-cols-[120px_1fr] items-center gap-4">
                ...
                <input 
                    name="password" 
                    bind:value={guru.password} 
                    type="text" 
                    required 
                    class="w-full text-gray-800 dark:text-gray-100 bg-zinc-50 dark:bg-zinc-950 border border-zinc-800 rounded-md p-2 text-sm focus:ring-1 focus:ring-green-700 focus:border focus:border-green-600 outline-none" 
                />
                <span class="text-xs font-semibold dark:text-gray-300 uppercase">NIP</span>
                <input 
                    name="nip" 
                    bind:value={guru.nip} 
                    type="text" 
                ...
                <textarea 
                    ...
                    class="w-full text-gray-800 dark:text-gray-100 bg-zinc-50 dark:bg-zinc-950 border border-zinc-800 rounded-md p-2 text-sm focus:ring-1 focus:ring-green-700 focus:border focus:border-green-600 outline-none" 
                ></textarea>
                <span class="text-xs font-semibold dark:text-gray-300 uppercase">Pendidikan</span>
                <input 
                    name="pendidikan" 
